...
public interface ReportService {
    ...
    List<WishMasterPerformanceSummaryDto> getWishMastersByHub(Long hubId);
    PerformanceReportDto getWishMasterDetailedReport(Long wishMasterId, LocalDate startDate, LocalDate endDate);
    List<WishMasterPerformanceSummaryDto> searchWishMasters(String employeeId);
    
    // Hub Admin Reports (scoped to their hub)
    List<WishMasterPerformanceSummaryDto> getHubWishMasters(Long hubAdminId);
    PerformanceReportDto getHubWishMasterDetailedReport(Long hubAdminId, Long wishMasterId, LocalDate startDate, LocalDate endDate);
    ...
    DailyPerformanceDto getMyDayPerformance(Long wishMasterId, LocalDate date);
}
